...
import { OrganizationPerson, OrganizationNode, OrganizationEdge, SurveyResponse } from '../types/OrganizationTypes';
...
export class LayoutService {
  ...
  public static createTreeLayout(
    ...
    hierarchyPeople.forEach(person => {
      ...
      const surveyResponse = surveyResponses.find(response => response.personId === person.id);
   ...
   */
  private static flattenHierarchy(hierarchy: OrganizationPerson[]): OrganizationPerson[] {
   ...
   */
  public static getCenterPosition(nodes: OrganizationNode[]): { x: number; y: number } {
