...
export class OrganizationTreeV2 implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        const recordCount = context.parameters.organizationDataSet?.sortedRecordIds?.length ?? 0;
        if (recordCount === 0) {
